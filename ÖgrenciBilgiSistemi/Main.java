...
import ÖgrenciBilgiSistemi.Course;
...
public class Main {
    public static void main(String[] args) {
        ...
        Teacher teacher1 = new Teacher("Burak", "444", "MATH");
        Teacher teacher2 = new Teacher("Mete", "333", "PHYSICS");
        Teacher teacher3 = new Teacher("Eda", "222", "ENG");

        mathematics.addTeacher(teacher1);
        physics.addTeacher(teacher2);
        english.addTeacher(teacher3);

        Student student1 = new Student("Hatice", "622", 11, mathematics, physics, english);
        student1.addBulkmidtermNote(87,73,91);
        student1.addBulkfinalNote(82,81,88);
        student1.isPass();

        Student student2 = new Student("Helena", "631", 11, mathematics, physics, english);
        student2.addBulkmidtermNote(92, 63, 55);
        student2.addBulkfinalNote(84, 79, 66);
        student2.isPass();

        Student student3 = new Student("Selena", "627", 11, mathematics, physics, english);
